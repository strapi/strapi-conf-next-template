...
import ticketFormStyles from './styles.module.scss';
  ...
  return formState === 'error' ? (
    ...
    >
      <div className={cn(formStyles.formRow, ticketFormStyles.formRow)}>
        <button
          type="submit"
          className={cn(formStyles.submit, formStyles.generateWithGithub, formStyles[formState], {
