...
export default function DecoratorTop() {
  return (
    ...
    >
      <rect x="180" y="240" width="60" height="60" fill="#150241" />
      <path d="M240 240V300H180L240 240Z" fill="#1E035B" />
      ...
      <rect x="180" y="300" width="60" height="60" fill="#150241" />
      <path d="M240 300V360H180L240 300Z" fill="#1E035B" />
      ...
      <circle cx="270" cy="330" r="30" fill="#1B0255" />
      <circle cx="270" cy="330" r="13.3333" fill="#886DFF" />
      <rect width="60" height="60" transform="matrix(1 0 0 -1 120 300)" fill="#1B0255" />
      <mask
        id="mask0"
        mask-type="alpha"
      ...
      <g mask="url(#mask0)">
        <circle r="60" transform="matrix(1 0 0 -1 120 240)" fill="#886DFF" />
      </g>
      <rect width="60" height="60" transform="matrix(1 0 0 -1 0 60)" fill="#1B0255" />
      <mask
        id="mask1"
        mask-type="alpha"
        maskUnits="userSpaceOnUse"
      ...
      <g mask="url(#mask1)">
        <circle r="60" transform="matrix(1 0 0 -1 0 0)" fill="#482D9E" />
      </g>
      <rect y="60" width="60" height="60" fill="#4700C9" />
      <rect y="90" width="30" height="30" fill="#1B0255" />
      <rect width="60" height="60" transform="matrix(1 0 0 -1 240 300)" fill="#482D9E" />
      <rect width="30" height="30" transform="matrix(1 0 0 -1 240 270)" fill="#1B0255" />
    </svg>
  );
}
