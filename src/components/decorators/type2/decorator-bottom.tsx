...
export default function DecoratorBottom() {
  return (
    ...
    >
      ...
      <g mask="url(#mask0)">
        <circle r="60" transform="matrix(-1 0 0 1 120 300)" fill="#886DFF" />
      </g>
      ...
      <rect x="120" y="180" width="60" height="60" fill="#1B0255" />
      <path d="M180 180V240H120L180 180Z" fill="#4700C9" />
      ...
      <rect width="60" height="60" transform="matrix(1 0 0 -1 0 240)" fill="#482D9E" />
      <rect width="30" height="30" transform="matrix(1 0 0 -1 0 210)" fill="#1B0255" />
      ...
      <rect y="300" width="60" height="60" fill="#482D9E" />
      <circle cx="30" cy="330" r="30" fill="#1B0255" />
      <circle cx="29.9998" cy="330" r="13.3333" fill="#886DFF" />
    </svg>
  );
}
