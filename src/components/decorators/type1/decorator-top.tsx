...
export default function DecoratorTop() {
  return (
    ...
    >
      ...
      <rect x="240" y="240" width="60" height="60" fill="#482D9E" />
      <circle cx="270" cy="270" r="30" fill="#1B0255" />
      <circle cx="270" cy="270" r="13.3333" fill="#886DFF" />
      <rect width="60" height="60" fill="#482D9E" />
      <circle cx="30" cy="30" r="30" fill="#1B0255" />
      <circle cx="29.9998" cy="30.0001" r="13.3333" fill="#886DFF" />
      ...
      <g mask="url(#mask0)">
        <circle r="60" transform="matrix(-1 0 0 1 240 300)" fill="#4700C9" />
      </g>
      ...
      <g mask="url(#mask1)">
        <circle r="60" transform="matrix(1 0 0 -1 0 60)" fill="#4700C9" />
      </g>
    </svg>
  );
}
